...
import com.example.change.foodorder.Helpers.FingerprintHandler;
...
public class FingerprintAuth extends AppCompatActivity {
    ...
    private static final String KEY_NAME = "simplyFoodFPKey";
    private Cipher cipher;
    private TextView textView;
    ImageView imgTickAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgTickAuth = findViewById(R.id.imgTickAuth);
